        ...
        <div id="openModal" class="modalDialog" role="dialog" >
            ...
            <div id="division" class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            <form action="home.html" method="POST">
                                ...
                                <div>
                                    <p id="centrar"><input id="field" class="form-control form-control-lg" type="password" name="contrasena" placeholder="Contraseña"> </p><br>
                                </div>
                                <div>
                                <button id="centrar" onclick="alert('Boton de registrarse')" 
                                accesskey=""type="submit" class="btn btn-danger btn-lg btn-block">Iniciar Sesión</button>
                                </div>
                            </form>
                    ...
                    <div class="centrarTexto">
                        <a href="paginas/login.php">¿Olvidaste tu contraseña?</a>
                    </div>
                    <div>
                        <a href="javascript:history.go(-2)">¿Aún no estás en Pinterest? Regístrate</a>
                    </div>
